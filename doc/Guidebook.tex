...
%.lp
\item[\ib{autonamewands}]
Automatically #name wands "{empty}" after determining that they are empty,
and likewise remove it from wands that have been recharged (default false).
%.lp
\item[\ib{autoopen}]
