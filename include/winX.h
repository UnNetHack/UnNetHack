...
E void null_out_status();
E void check_turn_events();
...
E void X11_player_selection();
E void X11_askname();
E void X11_get_nh_event();
E void X11_exit_nhwindows(const char *);
E void X11_suspend_nhwindows(const char *);
E void X11_resume_nhwindows();
