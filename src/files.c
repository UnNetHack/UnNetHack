...
#ifdef COMPRESS
STATIC_DCL void redirect(const char *,const char *,const char *, FILE *,BOOLEAN_P);
...
int parse_config_line(FILE *,char *,char *,char *, BOOLEAN_P);
...
#endif
#ifdef WHEREIS_FILE
STATIC_DCL void write_whereis(int);
#endif
