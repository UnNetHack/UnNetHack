...
static boolean pmatch_internal(const char *, const char *, boolean, const char *);
...
static boolean
pmatch_internal(const char *patrn,
                const char *strng,
...
char *
format_duration(long int seconds)
{
    long minutes = seconds / 60;
    long hours = minutes / 60;
    long days = hours / 24;
