 ...
 */
	...
	CLR_YELLOW),
    MON("wolf", S_DOG,
	LVL(5, 12, 4, 0, 0), (G_GENO|G_SGROUP|G_SHEOL|2),
	A(ATTK(AT_BITE, AD_PHYS, 2, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	CLR_BROWN),
    MON("werewolf", S_DOG,
	LVL(5, 12, 4, 20, -7), (G_NOGEN|G_NOCORPSE|G_SHEOL),
	...
	M2_NOPOLY|M2_WERE|M2_HOSTILE, M3_INFRAVISIBLE, CLR_BROWN),
    MON("warg", S_DOG,
	LVL(7, 12, 4, 0, -5), (G_GENO|G_SGROUP|G_SHEOL|2),
	...
	LVL(5, 12, 4, 0, -5), (G_NOHELL|G_GENO|G_SHEOL|G_SGROUP|2),
	...
	LVL(7, 12, 4, 20, 0), (G_NOHELL|G_GENO|G_SHEOL|1),
 ...
 */
    MON("gas spore", S_EYE,
	LVL(1, 3, 10, 0, 0), (G_NOCORPSE|G_GENO|G_SHEOL|1),
	...
	LVL(2, 1, 9, 10, 0), (G_GENO|G_SHEOL|5),
	...
	LVL(6, 13, 4, 0, 0), (G_NOCORPSE|G_NOHELL|G_GENO|G_SHEOL|2),
	...
	LVL(6, 13, 4, 0, 0), (G_NOCORPSE|G_GENO|G_SHEOL|2),
 ...
 */
	...
	LVL(9, 12, 5, 90, -8), (G_GENO|G_SHEOL|1),
	...
	LVL(13, 12, 0, 90, -8), (G_GENO|G_SHEOL|1),
 ...
 */
	...
	LVL(2, 12, 6, 10, -7), (G_GENO|G_SHEOL|2),
    ...
    MON("imp", S_IMP,
	LVL(3, 12, 2, 20, -7), (G_GENO|G_SHEOL|1),
    ...
    MON("lemure", S_IMP,
	LVL(3, 3, 7, 0, -7), (G_HELL|G_GENO|G_SHEOL|G_LGROUP|G_NOCORPSE|1),
	...
	M3_INFRAVISIBLE|M3_INFRAVISION, CLR_BROWN),
    MON("quasit", S_IMP,
	LVL(3, 15, 2, 20, -7), (G_GENO|G_SHEOL|2),
 ...
 */
	...
	LVL(4, 0, 8, 10, 0), (G_GENO|G_SHEOL|2),
	...
	LVL(5, 0, 8, 10, 0), (G_GENO|G_SHEOL|1),
	...
	LVL(6, 3, 8, 20, 0), (G_GENO|G_SHEOL|2),
 ...
 */
	...
	LVL(7, 3, 7, 0, 0), (G_GENO|G_SHEOL|2),
	...
	LVL(8, 3, 7, 10, 0), (G_GENO|G_SHEOL|1),
	...
	LVL(9, 3, 7, 20, 0), (G_GENO|G_SHEOL|1),
 ...
 */
	...
	LVL(3, 9, 5, 10, -5), (G_GENO|G_SHEOL|1),
	A(ATTK(AT_MAGC, AD_SPEL, 0, 0),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(5, 5, 10, 0, -5), (G_GENO|G_SHEOL|1),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	LVL(3, 1, 3, 0, 0), (G_GENO|G_SHEOL|4),
	A(ATTK(AT_BITE, AD_PHYS, 2, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(5, 1, 0, 0, 0), (G_GENO|G_SHEOL|2),
	A(ATTK(AT_BITE, AD_PHYS, 3, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(7, 1, 0, 0, 0), (G_GENO|G_SHEOL|1),
 ...
 */
	...
	LVL(5, 9, 0, 0, -2), (G_GENO|G_SHEOL|1),
	...
	LVL(6, 18, 4, 10, 0), (G_GENO|G_SHEOL|2),
	...
	LVL(8, 3, 2, 10, 0), (G_GENO|G_SHEOL|1),
	A(ATTK(AT_BITE, AD_PHYS, 3, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(12, 12, 6, 0, 0), (G_GENO|G_SHEOL|2),
	...
	LVL(14, 12, 5, 0, 0), (G_GENO|G_SHEOL|2),
	...
	LVL(20, 12, 5, 0, 0), (G_GENO|G_SHEOL|1),
 ...
 */
	...
	LVL(5, 15, 4, 0, 0), (G_GENO|G_SHEOL|1),
 ...
 */
	...
	LVL(10, 3, 3, 0, 0), (G_GENO|G_SHEOL|2),
	...
	LVL(12, 3, 3, 0, 0), (G_GENO|G_SHEOL|2),
 ...
 */
	...
	LVL(4, 24, 2, 70, 7), (G_GENO|G_SHEOL|2),
	...
	M3_INFRAVISIBLE, CLR_BROWN),
    MON("horse", S_UNICORN,
	LVL(5, 20, 5, 0, 0), (G_GENO|G_SHEOL|2),
	...
	LVL(7, 24, 4, 0, 0), (G_GENO|G_SHEOL|2),
 ...
 */
	...
	LVL(5, 20, 2, 30, 0), (G_NOHELL|G_SHEOL|G_GENO|G_NOCORPSE|1),
	...
	LVL(6, 20, 2, 30, 0), (G_GENO|G_SHEOL|G_NOCORPSE|1),
 ...
 */
	...
	LVL(8, 3, 5, 10, 0), (G_GENO|G_SHEOL|2),
	A(ATTK(AT_BITE, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(15, 9, 6, 20, 0), (G_GENO|G_SHEOL|2),
 ...
 */
    ...
    MON("xan", S_XAN,
	LVL(7, 18, -4, 0, 0), (G_GENO|G_SHEOL|3),
	...
	CLR_RED),
    MON("chillbug", S_XAN,
	LVL(10, 12, 0, 30, 0), (G_GENO|G_SHEOLONLY|G_LGROUP|4),
 ...
 */
	...
	LVL(3, 15, 0, 0, 0), (G_NOCORPSE|G_SHEOL|G_GENO|4),
	...
	LVL(5, 15, 0, 0, 0), (G_NOCORPSE|G_GENO|G_SHEOL|2),
 ...
 */
	...
	LVL(14, 10, -4, 55, -12), (G_HELL|G_SHEOL|G_NOCORPSE|1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), 
...
/* Weeping Angels */
	...
	LVL(12, 12, -5, 70, -7), (G_NOCORPSE|G_SGROUP|G_GENO|G_SHEOL|2),
	A(ATTK(AT_GAZE, AD_BLNK, 0, 0), ATTK(AT_CLAW, AD_DRLI, 1, 8),
	  ATTK(AT_CLAW, AD_DREN, 1, 8), ATTK(AT_TUCH, AD_LVLT, 1, 6),
	  NO_ATTK, NO_ATTK),
 ...
 */
    MON("bat", S_BAT,
	LVL(0, 22, 8, 0, 0), (G_GENO|G_SGROUP|G_SHEOL|1),
	A(ATTK(AT_BITE, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	CLR_BROWN),
    MON("giant bat", S_BAT,
	LVL(2, 22, 7, 0, 0), (G_GENO|G_SHEOL|2),
	A(ATTK(AT_BITE, AD_PHYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("raven", S_BAT,
	LVL(4, 20, 6, 0, 0), (G_GENO|G_SHEOL|2),
	...
	LVL(5, 20, 6, 0, 0), (G_GENO|G_SHEOL|2),
 ...
 */
	...
	LVL(6, 20, 2, 10, -3), (G_GENO|G_SHEOL|1),
 ...
 */
	...
	LVL(12, 9, 2, 10, 0), (G_GENO|G_SHEOL),
	A(ATTK(AT_BITE, AD_PHYS, 2, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(15, 9, -1, 20, 4), (G_GENO|G_SHEOL|1),
	...
	LVL(15, 9, -1, 20, -5), (G_GENO|G_SHEOL|1),
	A(ATTK(AT_BREA, AD_COLD, 4, 6), ATTK(AT_BITE, AD_PHYS, 3, 8),
	  ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK),
	...
	LVL(15, 9, -1, 20, -6), (G_GENO|G_SHEOL|1),
	...
	LVL(15, 9, -1, 20, -7), (G_GENO|G_SHEOL|1),
 ...
 */
	...
	LVL(8, 12, 3, 0, 0), (G_GENO|G_SHEOL|3),
	...
	LVL(8, 36, 2, 30, 0), (G_NOCORPSE|G_SHEOL|1),
	...
	LVL(8, 6, 2, 30, 0), (G_NOCORPSE|G_SHEOL|1),
 ...
 */
	...
	LVL(1, 0, 9, 0, 0), (G_GENO|G_SHEOL|1),
	A(ATTK(AT_NONE, AD_COLD, 0, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(3, 1, 7, 0, 0), (G_GENO|G_SHEOL|1),
	...
	LVL(3, 1, 7, 0, 0), (G_GENO|G_SHEOL|2),
 ...
 */
	...
	LVL(6, 6, 0, 0, 2), (G_GENO|G_SGROUP|G_SHEOL|1),
	A(ATTK(AT_WEAP, AD_PHYS, 2,10),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(2250, 750, 0, MS_BOAST, MZ_HUGE), 0, 0,
	M1_HUMANOID|M1_CARNIVORE,
	...
	LVL(8, 10, 6, 0, -2), (G_GENO|G_SGROUP|G_SHEOL|1),
	...
	LVL(10, 12, 3, 10, -3), (G_NOHELL|G_GENO|G_SGROUP|G_SHEOL|1),
	...
	LVL(16, 12, 3, 10, -3), (G_GENO|G_SGROUP|G_SHEOL|1),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 12),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	M3_INFRAVISIBLE|M3_INFRAVISION, CLR_BLUE),
    MON("ettin", S_GIANT,
	LVL(10, 12, 3, 0, 0), (G_GENO|G_SHEOL|1),
 ...
 */
	...
	LVL(15, 12, -2, 50, 0), (G_GENO|G_SHEOL|1),
 ...
 */
    MON("lich", S_LICH,
	LVL(11, 6, 0, 30, -9), (G_GENO|G_NOCORPSE|G_SHEOL|1),
    ...
    MON("demilich", S_LICH,
	LVL(14, 9, -2, 60, -12), (G_GENO|G_NOCORPSE|G_SHEOL|1),
	...
	LVL(17, 9, -4, 90, -15), (G_HELL|G_GENO|G_NOCORPSE|G_SHEOL|1),
	...
	LVL(25, 9, -6, 90, -15), (G_HELL|G_GENO|G_NOCORPSE|G_SHEOL|1),
 ...
 */
	...
	LVL(3, 8, 6, 20, -2), (G_GENO|G_NOCORPSE|G_SHEOL|1),
	A(ATTK(AT_CLAW, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(4, 10, 6, 20, -3), (G_GENO|G_NOCORPSE|G_SHEOL|1),
	...
	LVL(5, 10, 5, 20, -4), (G_GENO|G_NOCORPSE|G_SHEOL|1),
	A(ATTK(AT_CLAW, AD_PHYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(6, 12, 4, 30, -5), (G_GENO|G_NOCORPSE|G_SHEOL|1),
	...
	LVL(7, 12, 4, 30, -6), (G_GENO|G_NOCORPSE|G_SHEOL|1),
	A(ATTK(AT_CLAW, AD_PHYS, 2, 6), ATTK(AT_CLAW, AD_PHYS, 2, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(8, 14, 3, 30, -7), (G_GENO|G_NOCORPSE|G_SHEOL|1),
	A(ATTK(AT_CLAW, AD_PHYS, 3, 4), ATTK(AT_CLAW, AD_PHYS, 3, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	LVL(8, 14, 2, 10, 4), (G_SHEOL|G_GENO|1),
	...
	LVL(10, 14, 2, 70, 5), (G_SHEOL|G_GENO|1),
	...
	LVL(12, 16, 0, 50, 7), (G_SHEOL|G_GENO|1),
	...
	LVL(13, 14, 2, 40, 5), (G_SHEOLONLY|G_GENO|1),
 ...
 */
    MON("ogre", S_OGRE,
	LVL(5, 10, 5, 0, -3), (G_SHEOL|G_SGROUP|G_GENO|1),
	...
	LVL(7, 12, 3, 30, -5), (G_SHEOL|G_GENO|2),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(9, 14, 4, 60, -7), (G_SHEOL|G_GENO|2),
 ...
 */
	...
	LVL(10, 6, 6, 0, 0), (G_SHEOL|G_GENO|1),
	...
	LVL(6, 6, 6, 0, 0), (G_HELL|G_SHEOL|G_GENO|1),
	...
	LVL(11, 6, 6, 20, 0), (G_SHEOLONLY|G_GENO|1),
	A(ATTK(AT_TUCH, AD_FREZ, 1, 8), ATTK(AT_NONE, AD_FREZ, 0, 0),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(400, 150, 0, MS_SILENT, MZ_LARGE),
 ...
 */
	...
	LVL(5, 18, 2, 0, 0), (G_GENO|G_SHEOL|2),
 ...
 */
    MON("troll", S_TROLL,
	LVL(7, 12, 4, 0, -3), (G_GENO|G_SHEOL|2),
	...
	LVL(9, 10, 2, 20, -3), (G_NOHELL|G_SHEOL|G_GENO|1),
	...
	LVL(9, 12, 0, 0, -3), (G_GENO|G_SHEOL|1),
	...
	LVL(13, 12, -4, 0, -7), (G_GENO|G_SHEOL|1),
	A(ATTK(AT_WEAP, AD_PHYS, 3, 6), ATTK(AT_CLAW, AD_PHYS, 2, 8),
	  ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	LVL(9, 6, 2, 25, 0), (G_GENO|G_SHEOL|2),
	A(ATTK(AT_CLAW, AD_PHYS, 3, 4), ATTK(AT_CLAW, AD_PHYS, 3, 4),
 ...
 */
	...
	LVL(10, 12, 1, 25, -8), (G_GENO|G_SHEOL|G_NOCORPSE|1),
	...
	LVL(12, 14, 0, 50, -9), (G_GENO|G_SHEOL|G_NOCORPSE|1),
 ...
 */
	...
	LVL(3, 12, 5, 5, -3), (G_GENO|G_NOCORPSE|G_SHEOL|1),
    ...
    MON("wraith", S_WRAITH,
	LVL(6, 12, 4, 15, -6), (G_GENO|G_SHEOL|2),
    ...
    MON("Nazgul", S_WRAITH,
	LVL(13, 12, 0, 25, -17), (G_GENO|G_SHEOL|G_NOCORPSE|1),
 ...
 */
    MON("xorn", S_XORN,
	LVL(8, 9,-2, 20, 0), (G_GENO|G_SHEOL|1),
	A(ATTK(AT_CLAW, AD_PHYS, 1, 3), ATTK(AT_CLAW, AD_PHYS, 1, 3),
 ...
 */
    ...
    MON("yeti", S_YETI,
	LVL(5, 15, 6, 0, 0), (G_GENO|G_SHEOL|2),
	A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_CLAW, AD_PHYS, 1, 6),
	  ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	LVL(0, 6, 10, 0, -2), (G_GENO|G_SHEOL|G_NOCORPSE|1),
	A(ATTK(AT_CLAW, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(400, 50, 0, MS_SILENT, MZ_SMALL), MR_COLD|MR_SLEEP|MR_POISON, 0,
	M1_BREATHLESS|M1_MINDLESS|M1_HUMANOID|M1_POIS,
	...
	LVL(1, 6, 10, 0, -2), (G_GENO|G_SHEOL|G_NOCORPSE|1),
	...
	LVL(2, 6, 9, 0, -3), (G_GENO|G_SHEOL|G_SGROUP|G_NOCORPSE|1),
	A(ATTK(AT_CLAW, AD_PHYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(850, 75, 0, MS_SILENT, MZ_HUMAN), MR_COLD|MR_SLEEP|MR_POISON, 0,
	M1_BREATHLESS|M1_MINDLESS|M1_HUMANOID|M1_POIS,
	...
	LVL(3, 6, 9, 0, -3), (G_GENO|G_SHEOL|G_SGROUP|G_NOCORPSE|1),
	...
	LVL(4, 6, 8, 0, -3), (G_GENO|G_SHEOL|G_SGROUP|G_NOCORPSE|1),
	...
	LVL(6, 8, 6, 0, -4), (G_GENO|G_SHEOL|G_NOCORPSE|1),
	...
	LVL(8, 8, 6, 0, -4), (G_GENO|G_SHEOL|G_NOCORPSE|1),
	...
	CLR_CYAN),
    MON("ghoul", S_ZOMBIE,
	LVL(3, 6, 10, 0, -2), (G_GENO|G_SHEOL|G_NOCORPSE|1),
 ...
 */
	...
	LVL(11, 7, 7, 40, 0), (G_SHEOL|G_NOCORPSE|1),
	...
	LVL(14, 6, 5, 50, 0), (G_SHEOL|G_NOCORPSE|1),
	...
	LVL(16, 6, 1, 50, 0), (G_SHEOL|G_NOCORPSE|1),
	A(ATTK(AT_CLAW, AD_PHYS, 2, 8), ATTK(AT_CLAW, AD_PHYS, 2, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(18, 6, 3, 60, 0), (G_SHEOL|G_NOCORPSE|1),
	...
	LVL(22, 8, -5, 60, 0), (G_SHEOLONLY|G_NOCORPSE|1),
	A(ATTK(AT_WEAP, AD_PHYS, 7,10), ATTK(AT_BREA, AD_COLD, 8, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(2000, 0, 0, MS_SILENT, MZ_LARGE),
	MR_COLD|MR_ELEC|MR_SLEEP|MR_POISON, 0,
	M1_BREATHLESS|M1_MINDLESS|M1_HUMANOID|M1_THICK_HIDE|M1_POIS,
	M2_HOSTILE|M2_STRONG|M2_COLLECT, 0, CLR_BRIGHT_CYAN),
    MON("crystal ice golem", S_GOLEM,
	LVL(28, 9, -10, 30, 0), (G_SHEOLONLY|G_NOCORPSE|G_SGROUP|5),
 ...
 */
	...
	LVL(9, 12, 10, 25, -10), (G_GENO|G_SHEOL|1),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_ELF, 350, 0, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
	M1_HUMANOID|M1_OMNIVORE|M1_SEE_INVIS,
	...
	LVL(9, 12, 5, 20, 0), (G_GENO|G_SHEOL|1),
...
/* the black marketeer's speed (24) matches the speed boots he's wearing */
	...
	M3_INFRAVISIBLE, CLR_WHITE),
    MON("soldier", S_HUMAN,
	LVL(6, 10, 10, 0, -2), (G_SHEOL|G_SGROUP|G_GENO|1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(8, 10, 10, 5, -3), (G_SHEOL|G_SGROUP|G_GENO|1),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_SOLDIER, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
	...
	LVL(10, 10, 10, 15, -4), (G_SHEOL|G_GENO|1),
	...
	M3_INFRAVISIBLE, CLR_GREEN),
    MON("captain", S_HUMAN,
	LVL(12, 10, 10, 15, -5), (G_SHEOL|G_GENO|1),
	A(ATTK(AT_WEAP, AD_PHYS, 4, 4), ATTK(AT_WEAP, AD_PHYS, 4, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_SOLDIER, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
...
# define SEDUCTION_ATTACKS \
	...
	LVL(6, 12, 0, 70, -9), (G_SHEOL|G_NOCORPSE|1),
	SEDUCTION_ATTACKS,
 ...
 */
	...
	LVL(24, 25, -15, 95, 15), G_SHEOLONLY|G_NOCORPSE|1,
 ...
 */
	...
	LVL(16, 6, -2, 80, -14), (G_NOCORPSE|G_NOGEN|G_UNIQ|1),
	A(ATTK(AT_WEAP, AD_PHYS, 8, 8), ATTK(AT_WEAP, AD_PHYS, 4, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_SILENT, MZ_LARGE), MR_FIRE|MR_POISON, 0,
	M1_FLY|M1_SEE_INVIS|M1_POIS,
	...
	LVL(23, 6, -2, 30, -3), (G_NOGEN|G_UNIQ),
	A(ATTK(AT_CLAW, AD_PHYS, 2, 8), ATTK(AT_CLAW, AD_PHYS, 2, 8),
	  ATTK(AT_HUGS, AD_WRAP, 2, 8), ATTK(AT_BITE, AD_PHYS, 5, 8),
	  NO_ATTK, NO_ATTK),
	SIZ(2000, 1000, 0, MS_SILENT, MZ_HUGE), 0, 0,
	M1_SWIM|M1_AMPHIBIOUS|M1_ANIMAL|M1_NOHANDS|M1_CARNIVORE,
