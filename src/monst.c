...
/* Weeping Angels */
	...
	LVL(12, 12, -5, 70, -7), (G_NOCORPSE|G_SGROUP|G_GENO|G_SHEOL|1),
	A(ATTK(AT_CLAW, AD_DRLI, 1, 8), ATTK(AT_CLAW, AD_DREN, 1, 8),
	  ATTK(AT_TUCH, AD_LVLT, 1, 6), ATTK(AT_GAZE, AD_BLNK, 0, 0),
	  NO_ATTK, NO_ATTK),
