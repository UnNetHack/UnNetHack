...
static boolean H2Opotion_dip(struct obj *, struct obj *, boolean, const char *);
...
void
make_stoned(long int xtime, const char *msg, int killedby, const char *killername)
{
    long old = Stoned;
...
void
make_slimed(long int xtime, const char *msg)
{
    long old = Slimed;
