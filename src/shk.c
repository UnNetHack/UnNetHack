 ...
 */
long
money2mon(struct monst *mon, long int amount)
{
 ...
 */
void
money2u(struct monst *mon, long int amount)
{
...
static long
check_credit(long int tmp, struct monst *shkp)
{
...
static void
pay(long int tmp, struct monst *shkp)
{
 ...
 * Returns 0 if the item doesn't belong to a shopkeeper or hero is not in the shop. */
long
 ...
 */
long
contained_cost(struct obj *obj, struct monst *shkp, long int price, boolean usell, boolean unpaid_only)
{
    struct obj *otmp, *top;
    coordxy x, y;
...
void
alter_cost(struct obj *obj, long int amt)
...
static long
stolen_container(struct obj *obj, struct monst *shkp, long int price, boolean ininv)
{
    struct obj *otmp;
    struct bill_x *bp;
    long billamt;
...
void
add_damage(coordxy x, coordxy y, long int cost)
{
...
static const char *
shk_embellish(struct obj *itm, long int cost)
{
    if (!rn2(3)) {
        int o, choice = rn2(5);
...
void
costly_gold(coordxy x, coordxy y, long int amount)
{
    long delta;
    struct monst *shkp;
    struct eshk *eshkp;
