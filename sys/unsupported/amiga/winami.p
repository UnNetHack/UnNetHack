...
void amii_update_inventory ();
void amii_mark_synch ();
void amii_wait_synch ();
void amii_setclipped ();
...
void amii_init_nhwindows ();
int amii_get_ext_cmd();
...
int amii_nhgetch ();
void amii_get_nh_event ();
void amii_remember_topl ();
int amii_doprev_message ();
